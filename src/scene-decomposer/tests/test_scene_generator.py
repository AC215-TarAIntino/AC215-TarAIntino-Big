...
class TestSceneGenerator:
    ...
    @patch('trailer_generator.scene_generator.OpenAI')
    def test_generate_trailer_with_model_override(self, mock_openai_class, sample_movie, sample_trailer_data):
    ...
    @patch('trailer_generator.scene_generator.OpenAI')
    def test_generate_trailer_json_with_extra_text(self, mock_openai_class, sample_movie, sample_trailer_data):
    ...
    def test_validate_trailer_consistency_too_many_references(self):
        ...
        trailer = TrailerBreakdown(
            ...
            total_duration=30,
            character_designs=[
                CharacterDesign(character_name=f"Char_{i}", image_generation_prompt="test", brief_identifier="test", visual_style="realistic")
                for i in range(4)
            ],
            scenes=[
                TrailerScene(
    ...
    @patch('trailer_generator.scene_generator.OpenAI')
    def test_generate_trailer_without_narration(self, mock_openai_class, sample_movie, sample_trailer_data):
